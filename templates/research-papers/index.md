...
- **Browse in Obsidian** for graph view and backlink navigation.
- **Ingest a new paper**: `lorekeeper ingest path/to/paper.pdf --vault .`
- **Ask a question**: `lorekeeper query "what is …?" --vault .`
- **Audit for drift**: `lorekeeper lint --vault .`
...
<!-- lorekeeper may append entries below this line during ingest -->
